...
class TestAnalyzer:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self.db_fixture_pattern = re.compile(r'@pytest\.fixture.*\n\s*def\s+.*db.*\(')
    ...
    def analyze_test_file(self, file_path: Path, module_name: str) -> dict[str, Any]:
        """Analyze a test file.
        ...
        file_results = {
            ...
            'indicators': self._get_integration_indicators(content) if is_integration else [],
        }

        # Update overall results
        self._update_test_results(file_results, module_name)
    ...
    def _update_test_results(self, file_results: dict[str, Any], module_name: str) -> None:
        """Update test results.
    ...
    def analyze_testability(self, file_path: Path, module_name: str) -> None:
        ...
        for func_name, func_node in functions:
            ...
            if has_business_logic:
                self.results['testability']['functions_with_business_logic'] += 1
    ...
    def finalize_results(self) -> dict[str, Any]:
        ...
        total_with_logic = self.results['testability']['functions_with_business_logic']
    ...
    def get_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            'unit_percentage': round(self.results['test_ratio']['unit_percentage'], 1),
            'integration_percentage': round(self.results['test_ratio']['integration_percentage'], 1),
            'testability_score': round(self.results['testability']['testability_score'], 1),
            'untestable_functions': len(self.results['testability']['untestable_functions']),
        }
